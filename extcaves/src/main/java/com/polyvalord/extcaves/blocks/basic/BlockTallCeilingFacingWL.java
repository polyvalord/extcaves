...
public class BlockTallCeilingFacingWL extends BlockCeilingFacingWL 
{
	
	public static final EnumProperty<DoubleBlockHalf> HALF = BlockStateProperties.DOUBLE_BLOCK_HALF;

	public BlockTallCeilingFacingWL(Properties properties) 
	{
		super(properties);
		this.setDefaultState(this.stateContainer.getBaseState().with(HALF, DoubleBlockHalf.UPPER).with(HORIZONTAL_FACING, Direction.NORTH).with(WATERLOGGED, false));
	}
