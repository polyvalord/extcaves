...
public class BlockTreasurePotQuartzLong extends BlockGroundFacingWL 
{
	...
	private static final VoxelShape SHAPE_NORTH = VoxelShapes.or(
			...
			Block.makeCuboidShape(2.5, 5, 9.5, 4.5, 9, 10.5),
			Block.makeCuboidShape(9.5, 5, 9.5, 11.5, 9, 10.5)
			);
	private static final VoxelShape SHAPE_EAST = VoxelShapes.or(
			...
			Block.makeCuboidShape(5.5, 5, 2.5, 6.5, 9, 4.5),
			Block.makeCuboidShape(5.5, 5, 9.5, 6.5, 9, 11.5)
			);
	private static final VoxelShape SHAPE_SOUTH = VoxelShapes.or(
			...
			Block.makeCuboidShape(11.5, 5, 5.5, 13.5, 9, 6.5),
			Block.makeCuboidShape(4.5, 5, 5.5, 6.5, 9, 6.5)
			);
	private static final VoxelShape SHAPE_WEST = VoxelShapes.or(
			...
			Block.makeCuboidShape(9.5, 5, 11.5, 10.5, 9, 13.5),
			Block.makeCuboidShape(9.5, 5, 4.5, 10.5, 9, 6.5)
			);

	public BlockTreasurePotQuartzLong(Properties properties) 
	{
		super(properties);
	}
